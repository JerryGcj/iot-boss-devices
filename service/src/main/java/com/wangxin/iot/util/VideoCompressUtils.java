    ...
    public static File compressionVideo(String href){
        try{
           // 缓存到临时目录，压缩上传完到远程服务器上之后，记得删除源视频
            ...
            String fileName =  "zip.mp4" ;//+ href.substring(href.lastIndexOf("/") + 1);
...
//            }
    ...
    public static void main(String[] args) throws Exception {
        File file = new File("E:\\test\\aaa.mp4");
        File file1 = VideoCompressUtils.compressionVideo(file, "\\fuck.mp4");
    }
}
